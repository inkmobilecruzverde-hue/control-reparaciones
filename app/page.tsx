    ...
    ventana.document.write(`
      <html>
        ...
        <body>
          ...
          <div class="campo"><span class="titulo">Orden:</span> ${orden.numero}</div>
          <div class="campo"><span class="titulo">Fecha:</span> ${fecha.toLocaleString()}</div>

          <div class="linea"></div>

          <div class="campo"><span class="titulo">Cliente:</span> ${orden.nombre}</div>
          <div class="campo"><span class="titulo">Teléfono:</span> ${orden.telefono}</div>

          <div class="linea"></div>

          <div class="campo"><span class="titulo">Modelo:</span> ${orden.modelo}</div>
          <div class="campo"><span class="titulo">Problema:</span> ${orden.problema}</div>

          <div class="linea"></div>

          <div class="campo"><span class="titulo">Notas:</span> ${orden.notas || "-"}</div>
          <div class="campo"><span class="titulo">Presupuesto:</span> ${orden.presupuesto || "-"} €</div>

          <div class="linea"></div>

          <div class="campo"><span class="titulo">Estado:</span> ${orden.estado}</div>
